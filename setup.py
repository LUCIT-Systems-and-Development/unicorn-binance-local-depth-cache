...
setup(
     ...
     description="A Python SDK from LUCIT to access and manage multiple local Binance DepthCaches with Python in a "
     ...
     install_requires=['lucit-licensing-python>=1.8.2', 'Cython', 'requests>=2.31.0',
                       'unicorn-binance-websocket-api>=2.7.0', 'unicorn-binance-rest-api>=2.5.1'],
